                    ...
                    <form id="form1" action="admin/conexion/login.php" method="post" enctype="application/x-www-form-urlencoded" name="login_form">
                        <div class="row">
                            <div class="col s12 center">
                                <img src="images/logo.png" alt="" id="foto" class="responsive-img" style="max-width: 50%;">
                            </div>
                        ...
                        <div class="row">
                            <div class="input-field col s10 offset-s1">
                                ...
                                <input id="id_empleado" type="text" class="validate" name="id_empleado" required>
